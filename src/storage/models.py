...
SUBJECTS_BY_GRADE = {
    ...
    7: (
        "فارسی", "نگارش", "ریاضی", "علوم تجربی", "مطالعات اجتماعی", "پیام‌های آسمان", "قرآن",
        "عربی", "انگلیسی", "کار و فناوری", "فرهنگ و هنر", "تفکر و سبک زندگی",
    ),
    8: (
        "فارسی", "نگارش", "ریاضی", "علوم تجربی", "مطالعات اجتماعی", "پیام‌های آسمان", "قرآن",
        "عربی", "انگلیسی", "کار و فناوری", "فرهنگ و هنر", "تفکر و سبک زندگی",
    ...
    9: (
        "فارسی", "نگارش", "ریاضی", "علوم تجربی", "مطالعات اجتماعی", "پیام‌های آسمان", "قرآن",
        "عربی", "انگلیسی", "کار و فناوری", "فرهنگ و هنر", "آمادگی دفاعی", "تفکر و سبک زندگی",
    ),
}
...
HIGH_SCHOOL_SUBJECTS = {
    (10, AcademicMajor.MATH): (
        "فارسی و نگارش ۱", "عربی زبان قرآن ۱", "دین و زندگی ۱", "انگلیسی ۱", "ریاضی ۱",
        "هندسه ۱", "فیزیک ۱", "شیمی ۱", "آزمایشگاه علوم تجربی", "جغرافیای ایران",
        "آمادگی دفاعی", "تفکر و سواد رسانه‌ای", "هنر",
    ),
    (10, AcademicMajor.EXPERIMENTAL): (
        "فارسی و نگارش ۱", "عربی زبان قرآن ۱", "دین و زندگی ۱", "انگلیسی ۱", "ریاضی ۱",
        "زیست‌شناسی ۱", "فیزیک ۱", "شیمی ۱", "آزمایشگاه علوم تجربی", "جغرافیای ایران",
        "آمادگی دفاعی", "تفکر و سواد رسانه‌ای", "هنر",
    ),
    (10, AcademicMajor.HUMANITIES): (
        "فارسی و نگارش ۱", "عربی زبان قرآن ۱", "دین و زندگی ۱", "انگلیسی ۱", "ریاضی و آمار ۱",
        "علوم و فنون ادبی ۱", "اقتصاد", "جامعه‌شناسی ۱", "تاریخ ۱", "جغرافیای ایران", "منطق",
        "روان‌شناسی/دروس مربوط به برنامه رشته", "آمادگی دفاعی", "تفکر و سواد رسانه‌ای", "هنر",
    ),
    (11, AcademicMajor.MATH): (
        "فارسی و نگارش ۲", "عربی زبان قرآن ۲", "دین و زندگی ۲", "انگلیسی ۲", "حسابان ۱",
        "هندسه ۲", "آمار و احتمال", "فیزیک ۲", "شیمی ۲", "آزمایشگاه علوم تجربی ۲",
        "تاریخ معاصر ایران", "انسان و محیط زیست", "زمین‌شناسی/دروس مربوط به برنامه", "آمادگی دفاعی",
    ),
    (11, AcademicMajor.EXPERIMENTAL): (
        "فارسی و نگارش ۲", "عربی زبان قرآن ۲", "دین و زندگی ۲", "انگلیسی ۲", "ریاضی ۲",
        "زیست‌شناسی ۲", "فیزیک ۲", "شیمی ۲", "آزمایشگاه علوم تجربی ۲", "زمین‌شناسی",
        "تاریخ معاصر ایران", "انسان و محیط زیست", "آمادگی دفاعی",
    ),
    (11, AcademicMajor.HUMANITIES): (
        "فارسی و نگارش ۲", "عربی زبان قرآن ۲", "دین و زندگی ۲", "انگلیسی ۲", "ریاضی و آمار ۲",
        "علوم و فنون ادبی ۲", "جامعه‌شناسی ۲", "تاریخ ۲", "جغرافیا ۲", "فلسفه ۱", "روان‌شناسی",
        "انسان و محیط زیست", "تاریخ معاصر ایران", "آمادگی دفاعی",
    ),
    (12, AcademicMajor.MATH): (
        "فارسی و نگارش ۳", "عربی زبان قرآن ۳", "دین و زندگی ۳", "انگلیسی ۳", "حسابان ۲",
        "هندسه ۳", "ریاضیات گسسته", "فیزیک ۳", "شیمی ۳", "هویت اجتماعی", "سلامت و بهداشت",
        "مدیریت خانواده و سبک زندگی", "آمادگی دفاعی",
    ),
    (12, AcademicMajor.EXPERIMENTAL): (
        "فارسی و نگارش ۳", "عربی زبان قرآن ۳", "دین و زندگی ۳", "انگلیسی ۳", "ریاضی ۳",
        "زیست‌شناسی ۳", "فیزیک ۳", "شیمی ۳", "هویت اجتماعی", "سلامت و بهداشت",
        "مدیریت خانواده و سبک زندگی", "آمادگی دفاعی",
    ),
    (12, AcademicMajor.HUMANITIES): (
        "فارسی و نگارش ۳", "عربی زبان قرآن ۳", "دین و زندگی ۳", "انگلیسی ۳", "ریاضی و آمار ۳",
        "علوم و فنون ادبی ۳", "جامعه‌شناسی ۳", "تاریخ ۳", "جغرافیا ۳", "فلسفه ۲", "هویت اجتماعی",
        "سلامت و بهداشت", "مدیریت خانواده و سبک زندگی", "آمادگی دفاعی",
    ),
}
